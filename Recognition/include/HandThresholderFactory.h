...
enum HandThresholderType { HSV_THRESHOLDER, HISTOGRAM_HSV_THRESHOLDER, YCBCR_THRESHOLDER, YCBCR_ELLIPSE_THRESHOLDER, ADAPTIVE_THRESHOLDER, LUMA_THRESHOLDER, LUMA_MEAN_THRESHOLDER };
